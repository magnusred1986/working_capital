...
Архивирует данные складов на вчера, сравнивает изменения складов на вчера/сегодня. Сводит все данные в единый `DF` на основании которого строится сводная таблица. 
Обновляет сводную таблицу с результатами операционной деятельности. Отправляет результат работы на почту с `log` файлом.
